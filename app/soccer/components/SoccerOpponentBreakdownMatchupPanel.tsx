...
type OpponentInsightsTab = 'opponent_breakdown' | 'team_matchup';
...
export function SoccerOpponentBreakdownMatchupPanel({
  ...
  const [tab, setTab] = useState<OpponentInsightsTab>('opponent_breakdown');
  const [tabsVisited, setTabsVisited] = useState<Set<OpponentInsightsTab>>(() => new Set(['opponent_breakdown']));
