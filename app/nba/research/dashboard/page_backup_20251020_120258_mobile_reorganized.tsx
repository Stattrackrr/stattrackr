...
className="flex-1 lg:flex-[7] min-w-0 min-h-0 flex flex-col gap-3 sm:gap-4 md:gap-6 overflow-y-auto lg:pr-4 overscroll-contain"
          ...
          >
            ...
            <div className="lg:hidden bg-white dark:bg-slate-800 rounded-lg shadow-sm p-3 md:p-4 lg:p-6 border border-gray-200 dark:border-gray-700">
...
<div className={`font-mono whitespace-nowrap ${bestSets.AST.under.has(i) ? green : grey}`}>U {displayHalfLine(row.AST.line)} ({oddsFormat === 'decimal' ? fmtOdds(row.AST.under) : row.AST.under})</div>
          ...
          >
            ...
            <div className="hidden lg:block bg-white dark:bg-slate-800 rounded-lg shadow-sm px-3 md:px-4 lg:px-6 pt-3 md:pt-4 pb-4 md:pb-5 border border-gray-200 dark:border-gray-700">
              <h3 className="text-sm md:text-base lg:text-lg font-semibold text-gray-900 dark:text-white mb-3">Filter By</h3>
              <div className="flex gap-2 md:gap-3 flex-wrap mb-3">
                <button
                  onClick={() => {
            ...
            {/* Combined Opponent Analysis & Team Matchup (Desktop) - always visible in both modes */}
              <div className="hidden lg:block bg-white dark:bg-slate-800 rounded-lg shadow-sm p-3 md:p-4 lg:p-6 border border-gray-200 dark:border-gray-700">
                {/* Section 1: Opponent Analysis */}
                <OpponentAnalysisCard 
                  isDark={isDark} 
                  opponentTeam={opponentTeam} 
