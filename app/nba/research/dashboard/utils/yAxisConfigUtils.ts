...
export function calculateYAxisConfig({
  ...
  const smallIncrementStats = ['reb', 'ast', 'fg3m', 'fg3a', 'fgm', 'fga', 'ftm', 'fta', 'oreb', 'dreb', 'double_double', 'triple_double', 'turnover', 'pf', 'stl', 'blk', 'q1_pts', 'q1_reb', 'q1_ast', 'q2_pts', 'q3_pts', 'q4_pts'];
