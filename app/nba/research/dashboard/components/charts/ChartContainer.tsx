...
import { getEspnLogoUrl, getEspnLogoCandidates } from '../../constants';
...
// ChartControls will be passed as a prop for now since it's still in page.tsx
const ChartContainer = memo(function ChartContainer({
  ...
  sliderRange,
  setSliderRange,
  ChartControls, // Pass ChartControls as a prop for now
}: any) {
