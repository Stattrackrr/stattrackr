...
function NBADashboardContent() {
  ...
  const fetchTodaysGames = async () => {
    try {
      ...
      // Fetch only a small date range (today ± 7 days) to avoid paging huge seasons
    ...
    <div className="min-h-screen lg:h-screen bg-gray-50 dark:bg-gray-900 transition-colors lg:overflow-hidden">
      ...
      <div 
        ...
        style={{
          ...
          marginRight: 'var(--content-margin-right)',
          paddingRight: 'var(--content-padding-right)'
        }}
      >
        <LeftSidebar oddsFormat={oddsFormat} setOddsFormat={setOddsFormat} />
        <div className="flex flex-col lg:flex-row gap-1 min-h-0" style={{ marginLeft: 'calc(var(--sidebar-width, 0px) + 12px)' }}>
          {/* Main content area */}
          <div 
className="flex-1 lg:flex-[7] min-w-0 min-h-0 flex flex-col gap-2 sm:gap-3 md:gap-4 overflow-y-auto lg:pr-2 overscroll-contain"
            style={{
          ...
          >
            ...
            {useMemo(() => (
              <div className="hidden lg:block bg-white dark:bg-slate-800 rounded-lg shadow-sm px-6 py-5 border border-gray-200 dark:border-gray-700 w-full flex-shrink-0">
...
<div className={`font-mono whitespace-nowrap ${bestSets.AST.under.has(i) ? green : grey}`}>U {displayHalfLine(row.AST.line)} ({oddsFormat === 'decimal' ? fmtOdds(row.AST.under) : row.AST.under})</div>
          ...
          <div 
            className="flex-1 lg:flex-[3] flex flex-col gap-2 sm:gap-3 md:gap-4 lg:h-screen lg:max-h-screen lg:overflow-y-auto lg:pr-3 xl:pr-4"
            style={{
              scrollbarWidth: 'thin',
              scrollbarColor: isDark ? '#4b5563 transparent' : '#d1d5db transparent'
            }}
          >
            ...
            <div className="hidden lg:block bg-white dark:bg-slate-800 rounded-lg shadow-sm px-2 pt-2 pb-3 border border-gray-200 dark:border-gray-700">
              <h3 className="text-sm md:text-base lg:text-lg font-semibold text-gray-900 dark:text-white mb-3">Filter By</h3>
              <div className="flex gap-2 md:gap-3 flex-wrap mb-3">
                <button
                  onClick={() => {
          ...
          <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-gray-300 dark:bg-slate-900 border-t-2 border-gray-200 dark:border-gray-700 px-6 py-4 shadow-lg z-50">
            <div className="flex justify-between items-center divide-x divide-gray-400 dark:divide-gray-600">
              
              {/* Sports Dropdown */}
              <div className="flex-1 px-4 relative">
                <button 
                  onClick={() => setShowSportsDropdown(!showSportsDropdown)}
                  className="w-full px-4 py-3 text-lg font-semibold text-black dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-300 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg transition-colors flex items-center justify-center gap-2"
                >
                  Sports
                ...
                {showSportsDropdown && (
                  <div className="absolute bottom-full left-0 right-0 mb-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg">
                    <Link href="/research" className="block px-4 py-3 text-sm font-medium text-black dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 first:rounded-t-lg">All Sports</Link>
                    <Link href="/nba/research/dashboard" className="block px-4 py-3 text-sm font-medium text-black dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">NBA</Link>
                    <Link href="/nfl/research/dashboard" className="block px-4 py-3 text-sm font-medium text-black dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">NFL</Link>
                    <Link href="/nbl/research/dashboard" className="block px-4 py-3 text-sm font-medium text-black dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">NBL</Link>
                    <Link href="/tennis/research/dashboard" className="block px-4 py-3 text-sm font-medium text-black dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">TENNIS</Link>
                    <Link href="/soccer/research/dashboard" className="block px-4 py-3 text-sm font-medium text-black dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 last:rounded-b-lg">SOCCER</Link>
                  </div>
                )}
              </div>
              ...
              <div className="flex-1 px-4">
                <Link href="/journal" className="block w-full px-4 py-3 text-lg font-semibold text-black dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-300 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg transition-colors text-center">Journal</Link>
              </div>
              ...
              <div className="flex-1 px-4">
                <button 
                  onClick={() => {}}
                  className="w-full px-4 py-3 text-lg font-semibold text-black dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-300 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg transition-colors"
                >
                  Settings
                </button>
              </div>
