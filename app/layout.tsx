...
export const metadata: Metadata = {
  ...
  description: "Advanced multi-sport statistics dashboard covering NBA, AFL, NBL, ATP, and WTA. Analyze player statistics, team trends, game props, and matchup data with fast, data-driven tools.",
  keywords: [
    "sports analytics",
