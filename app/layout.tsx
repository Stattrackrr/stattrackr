...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/images/stattrackr-icon.png?v=20260302", sizes: "48x48", type: "image/png" },
      { url: "/images/stattrackr-icon.png?v=20260302", sizes: "192x192", type: "image/png" },
      { url: "/images/stattrackr-icon.png?v=20260302", sizes: "512x512", type: "image/png" },
    ],
    shortcut: [
      { url: "/images/stattrackr-icon.png?v=20260302", type: "image/png" },
    ],
    apple: [
      { url: "/images/stattrackr-icon.png?v=20260302", sizes: "180x180", type: "image/png" },
    ],
  },
  appleWebApp: {
    capable: true,
